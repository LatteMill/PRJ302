            ...
            <tr>
                ...
                <td id='content1'>
                    <form action="Exercise4" method="POST" style="margin:auto" id="f">
                        <h1 align="center">CÁC THAO TÁC VỚI MẢNG</h1>
                        <table align="center">
                            <tbody>
                                <tr>
                                    <td>Nhập đoạn văn</td>
                                ...
                                <tr>
                                    <td>Chọn</td>
                                    <td>
                                        <input type="radio" name="opt" value="nhapMang">Nhập mảng
                                        <input type="radio" name="opt" value="inMang">In mảng
                                        <input type="radio" name="opt" value="tongLe">Tổng lẻ
                                        <input type="radio" name="opt" value="tichChan">Tích chẵn
                                        <input type="radio" name="opt" value="sapXep">Sắp xếp
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
